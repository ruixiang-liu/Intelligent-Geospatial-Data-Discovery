...
2. Get the Top 10 datasets generated by the answer synthesis agent in the **first** section of the central panel.
3. For **Figure 10**, use the **links of Data.gov** to get the results from the portal (As of June 2026, the prefix is catalog-old.data.gov if you use the links below because of the updates of the website):
...
6. **igdd_evaluation_summary.csv** provides an overview of the 100 benchmark questions generated from **igdd_evaluation_with pool and score.csv**, including EIMR, NDCG@10, and Recall@10 values. Please note that all of the prefix of data.gov website is now catalog-old.data.gov because of the updates of the website. (As of June 2026)
